...
public class CouldElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String elastic_hostname = System.getProperty("elastic_hostname"); // localhost or bonsai url
        String elastic_username = System.getProperty("elastic_username"); // needed only for bonsai
        String elastic_password = System.getProperty("elastic_password"); // needed only for bonsai

        // credentials provider help supply elastic_username and elastic_password
    ...
    public static void main(String[] args) throws IOException {
        Logger logger = LoggerFactory.getLogger(CouldElasticSearchConsumer.class.getName());
            ...
            for (ConsumerRecord<String, String> record : records){
                ...
                try {
                    ...
                    IndexRequest indexRequest = new IndexRequest(elasticSearchIndexName, elasticSearchIndexType)
                            .id(id)
                            .source(XContentType.JSON, "field", record.value());
