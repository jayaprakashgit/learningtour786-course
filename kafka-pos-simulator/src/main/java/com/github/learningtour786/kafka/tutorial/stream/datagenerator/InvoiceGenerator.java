...
import com.github.learningtour786.kafka.tutorial.stream.types.LineItem;
...
public class InvoiceGenerator {
    ...
    private InvoiceGenerator() {
        ...
        try {
            ...
            invoices = mapper.readValue(new InputStreamReader(getClass().getResourceAsStream("/data/Invoice.json")), PosInvoice[].class);
        } catch (Exception e) {
