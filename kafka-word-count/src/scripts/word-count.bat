rem moving to the apache kafka directory to run the kafka commands
cd C:\App\kafka_2.12-2.1.0
...
java -jar C:\JP\Projects\jayaprakashgit\learningtour786-course\kafka-word-count\target\kafka-word-count-1.0-SNAPSHOT-jar-with-dependencies.jar
