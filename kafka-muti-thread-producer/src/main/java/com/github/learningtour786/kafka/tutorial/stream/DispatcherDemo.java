...
public class DispatcherDemo {
    ...
    public static void main(String[] args){
        ...
        logger.info("Starting com.github.learningtour786.kafka.tutorial.stream.Dispatcher threads...");
        ...
        try {
            ...
            producer.close();
            logger.info("Finished com.github.learningtour786.kafka.tutorial.stream.Dispatcher Demo");
        }
    }
}
